...
.dshpc_settings <- function() {
  list(
    ...
    runtime_revision = .dshpc_option("runtime_revision", ""),
    ...
    kubernetes_kubectl = .dshpc_option("kubernetes_kubectl",
      Sys.getenv("DSHPC_KUBERNETES_KUBECTL", unset = "")),
    kubernetes_context = .dshpc_option("kubernetes_context",
      Sys.getenv("DSHPC_KUBERNETES_CONTEXT", unset = "")),
    kubernetes_namespace = .dshpc_option("kubernetes_namespace",
      Sys.getenv("DSHPC_KUBERNETES_NAMESPACE", unset = "default")),
    kubernetes_service_account = .dshpc_option("kubernetes_service_account",
      Sys.getenv("DSHPC_KUBERNETES_SERVICE_ACCOUNT", unset = "")),
    kubernetes_image = .dshpc_option("kubernetes_image",
      Sys.getenv("DSHPC_KUBERNETES_IMAGE", unset = "")),
    kubernetes_image_pull_policy = .dshpc_option("kubernetes_image_pull_policy",
      Sys.getenv("DSHPC_KUBERNETES_IMAGE_PULL_POLICY", unset = "IfNotPresent")),
    kubernetes_pvc = .dshpc_option("kubernetes_pvc",
      Sys.getenv("DSHPC_KUBERNETES_PVC", unset = "")),
    kubernetes_mount_path = .dshpc_option("kubernetes_mount_path",
      Sys.getenv("DSHPC_KUBERNETES_MOUNT_PATH", unset = "")),
    kubernetes_backoff_limit = as.integer(.dshpc_option("kubernetes_backoff_limit",
      Sys.getenv("DSHPC_KUBERNETES_BACKOFF_LIMIT", unset = "0"))),
    kubernetes_ttl_seconds_after_finished = as.integer(
      .dshpc_option("kubernetes_ttl_seconds_after_finished",
        Sys.getenv("DSHPC_KUBERNETES_TTL_SECONDS_AFTER_FINISHED", unset = "86400"))),
